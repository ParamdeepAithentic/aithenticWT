...
#-------------------------------------------BILLING-----------------------------------------------------
    ...
    SubscriptionPage.Click on the values inside subscription connector table
    Sleep    ${yop_sleep}
    Switch Window      Sign in - Google Accounts
    Generic.Verify your current page location contains      signin
    SubscriptionPage.Enter the value in the email field of google sigin     puneet.dudi@aithentic.dev
    SubscriptionPage.Click on the next button
    sleep   2
    SubscriptionPage.Enter the value in the password field of google sigin      Aithentic@1234#
    SubscriptionPage.Click on the next button
    sleep   3
    SubscriptionPage.Click on the way how to sign in
    sleep   2
    SubscriptionPage.Enter the verification code        187866
