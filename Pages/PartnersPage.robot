...
Add Unique address_one of partner
    ...
    input text      ${partner_address_Line1}     ${generate_newaddress}
...
Add Unique address_two of partner
    ...
    ${random_string} =    Generate Random String       10      [LETTERS]
    ${generate_newaddress}=    Catenate    ${random_string}
    input text      ${partner_address_Line2}     ${generate_newaddress}
...
Add new address_two of partner
    ...
    ${random_string} =    Generate Random String       10      [LETTERS]
    ${generate_newaddress}=    Catenate    ${random_string}
    input text      ${partner_newaddress_Line2}     ${generate_newaddress}
