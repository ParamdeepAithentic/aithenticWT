...
Click on Searched Discovered asset
   Wait Until Element Is Not Visible    ${loaderIcon}      ${wait_time}
#   Wait Until Element Is Visible    ${Discovery_Assets}     ${wait_time}
    Wait Until Element Is Visible    //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]     ${wait_time}
    Wait Until Element Is enabled    //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]     ${wait_time}
#   Wait Until Element Is Enabled    ${Discovery_Assets}     ${wait_time}
   Click element    //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]
   Sleep    ${search sleep}
   wait until element is not visible       ${shadow}          ${wait_time}
...
Mouse Hover over searched Discovered Assets
    ...
    Wait Until Element Is Visible   //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]     ${wait_time}
    Wait Until Element Is Enabled    //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]     ${wait_time}
    Mouse Over    //div[contains(text(),'${UAT_Brand}')]//ancestor::div[contains(@class,'qa-assets-boxes')]//child::div[contains(@class,'box position-relative')]
